...
const textContent = {
  fr: {
    ...
    profiles: [
      { name: 'Iliana', role: 'Programmation et entraînement du réseau de neurones', photo: profileIliana },
  ...
  en: {
    ...
    profiles: [
      { name: 'Iliana', role: 'Programming and training of the neural network', photo: profileIliana },
